...
/**
 * A catalog of dependencies accessible via the `notLibs` extension.
*/
@NonNullApi
public class LibrariesForNotLibs extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForNotLibs(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects) {
